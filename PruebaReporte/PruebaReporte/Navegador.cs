...
namespace Navegador
{
    ...
    {
        [Description("Digito de preferencia para visualizar el reporte[1= Vista Previa | 0= Imprimir ")]
        [Category("ParametrosReporte")]
        public int VistaReporte { get; set; }
        [Description("Codigo de Aplicacion")]
        [Category("ParametrosAPP")]
        ...
        {
            if (IdApp != -1) {
                gReport.establecerParametrosDB("127.0.0.1", "root", "pruebareportes", "");
                gReport.cargarReporte(IdApp, VistaReporte);
            }
        }
