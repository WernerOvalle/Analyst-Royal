...
namespace Navegador
{
    public partial class Navegador : UserControl
    {
        ...
        {
            //llamada a los metodos del reporteados
        }
        ...
        {
            /*tiene que actualizar los combobox, ejemplo: tengo la tabla de marcas 
            y agrego una marca mas esa marca que agregue se tiene que agregar a la tabla de marcas y 
            cuando la busque tiene que estar*/
        }
    }
}
